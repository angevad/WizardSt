...
//  HINSTANCE hi; 
  ...
  csi.pwszName = OLESTR ("atl_dll.Shape");
  csi.dwReserved1 = 0;
  csi.dwReserved2 = 0;
  csi.pAuthInfo   = NULL;
  IClassFactoryPtr UnkPtr;
  hr = CoGetClassObject (CLSID_Shape, CLSCTX_INPROC_SERVER, &csi, IID_IClassFactory, (void**)&UnkPtr);
  if (SUCCEEDED (hr))
    {
    UnkPtr->CreateInstance (0, IID_IShape, (void**)&pShape);
    pShape->Draw ();
    }
